...
<template>
  <div class="relative flex flex-col md:flex-row" ref="dropZoneRef">
    <transition name="fade">
      <div
          v-if="isOverDropZone"
          class="pointer-events-none absolute inset-0 z-50 grid place-items-center rounded-2xl bg-black/20 border-3 border-dashed border-white/50 scale-101"
      >
        <div class="rounded-2xl border-2 border-white/70 bg-white/90 px-6 py-4 text-center shadow-lg">
